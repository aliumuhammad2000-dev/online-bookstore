export default function CartSummary({ subtotal }) {
  ...
  return (
    <aside className="rounded-2xl border border-stone-200 bg-white p-6 sm:p-8">
      ...
      <button type="button" disabled title="Checkout is coming soon" className="mt-7 min-h-12 w-full rounded-full bg-[#243e36] px-6 py-3 text-sm font-semibold text-white opacity-60">Proceed to checkout</button>
    </aside>
  )
}
